...
export class ExcelParserService {
  ...
  private readonly ROLE_MAPPING: Record<string, UserRole> = {
    ...
    'Thư ký Hội đồng': UserRole.GIANG_VIEN,
    'Thành viên Hội đồng': UserRole.GIANG_VIEN,
  ...
  private readonly STATE_MAPPING: Record<string, ProjectState> = {
    ...
    'Xét duyệt Khoa': ProjectState.FACULTY_COUNCIL_OUTLINE_REVIEW,
    'Chọn Hội đồng': ProjectState.SCHOOL_COUNCIL_OUTLINE_REVIEW,
    'Họp Hội đồng': ProjectState.SCHOOL_COUNCIL_OUTLINE_REVIEW,
    'Yêu cầu sửa': ProjectState.CHANGES_REQUESTED,
    'Đã duyệt': ProjectState.APPROVED,
    'Đang thực hiện': ProjectState.IN_PROGRESS,
    'Nghiệm thu Khoa': ProjectState.FACULTY_COUNCIL_ACCEPTANCE_REVIEW,
    'Nghiệm thu Trường': ProjectState.SCHOOL_COUNCIL_ACCEPTANCE_REVIEW,
    'Bàn giao': ProjectState.HANDOVER,
    'Hoàn thành': ProjectState.COMPLETED,
    // English alternatives
    'DRAFT': ProjectState.DRAFT,
    'FACULTY_REVIEW': ProjectState.FACULTY_COUNCIL_OUTLINE_REVIEW,
    'SCHOOL_SELECTION_REVIEW': ProjectState.SCHOOL_COUNCIL_OUTLINE_REVIEW,
    'OUTLINE_COUNCIL_REVIEW': ProjectState.SCHOOL_COUNCIL_OUTLINE_REVIEW,
    'CHANGES_REQUESTED': ProjectState.CHANGES_REQUESTED,
    'APPROVED': ProjectState.APPROVED,
    'IN_PROGRESS': ProjectState.IN_PROGRESS,
    'FACULTY_ACCEPTANCE_REVIEW': ProjectState.FACULTY_COUNCIL_ACCEPTANCE_REVIEW,
    'SCHOOL_ACCEPTANCE_REVIEW': ProjectState.SCHOOL_COUNCIL_ACCEPTANCE_REVIEW,
