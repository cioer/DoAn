...
const stateOptions: Array<{ value: ProjectState | ''; label: string }> = [
  ...
  { value: ProjectState.FACULTY_COUNCIL_OUTLINE_REVIEW, label: 'Đang xét (Khoa)' },
  { value: ProjectState.SCHOOL_COUNCIL_OUTLINE_REVIEW, label: 'Đang xét (Trường)' },
  { value: ProjectState.SCHOOL_COUNCIL_OUTLINE_REVIEW, label: 'Đang xét (Hội đồng)' },
  { value: ProjectState.CHANGES_REQUESTED, label: 'Yêu cầu sửa' },
  { value: ProjectState.APPROVED, label: 'Đã duyệt' },
  { value: ProjectState.IN_PROGRESS, label: 'Đang thực hiện' },
  { value: ProjectState.FACULTY_COUNCIL_ACCEPTANCE_REVIEW, label: 'Nghiệm thu (Khoa)' },
  { value: ProjectState.SCHOOL_COUNCIL_ACCEPTANCE_REVIEW, label: 'Nghiệm thu (Trường)' },
  { value: ProjectState.HANDOVER, label: 'Bàn giao' },
  { value: ProjectState.COMPLETED, label: 'Đã hoàn thành' },
