...
const stateOptions: Array<{ value: ProjectState | ''; label: string }> = [
  ...
  { value: ProjectState.FACULTY_REVIEW, label: 'Đang xét (Khoa)' },
  { value: ProjectState.SCHOOL_SELECTION_REVIEW, label: 'Đang xét (Trường)' },
  { value: ProjectState.OUTLINE_COUNCIL_REVIEW, label: 'Đang xét (Hội đồng)' },
