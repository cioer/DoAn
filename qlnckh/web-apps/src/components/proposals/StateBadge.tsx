...
const stateStyles: Record<ProjectState, string> = {
  ...
  [ProjectState.FACULTY_REVIEW]: 'bg-blue-100 text-blue-800',
  [ProjectState.SCHOOL_SELECTION_REVIEW]: 'bg-purple-100 text-purple-800',
  [ProjectState.OUTLINE_COUNCIL_REVIEW]: 'bg-indigo-100 text-indigo-800',
  ...
  [ProjectState.FACULTY_ACCEPTANCE_REVIEW]: 'bg-cyan-100 text-cyan-800',
  [ProjectState.SCHOOL_ACCEPTANCE_REVIEW]: 'bg-sky-100 text-sky-800',
...
const stateNames: Record<ProjectState, string> = {
  ...
  [ProjectState.FACULTY_REVIEW]: 'Đang xét (Khoa)',
  [ProjectState.SCHOOL_SELECTION_REVIEW]: 'Đang xét (Trường)',
  [ProjectState.OUTLINE_COUNCIL_REVIEW]: 'Đang xét (Hội đồng)',
