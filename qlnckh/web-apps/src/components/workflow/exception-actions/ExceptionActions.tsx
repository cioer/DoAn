...
function canReject(proposalState: string, userRole: string): boolean {
  ...
  const REJECT_PERMISSIONS: Record<string, string[]> = {
    QUAN_LY_KHOA: ['FACULTY_COUNCIL_OUTLINE_REVIEW', 'CHANGES_REQUESTED'],
    PHONG_KHCN: [
      'FACULTY_COUNCIL_OUTLINE_REVIEW',
      'SCHOOL_COUNCIL_OUTLINE_REVIEW',
      'CHANGES_REQUESTED',
    ],
    THU_KY_HOI_DONG: ['SCHOOL_COUNCIL_OUTLINE_REVIEW'],
    THANH_TRUNG: ['SCHOOL_COUNCIL_OUTLINE_REVIEW'],
    CHU_TICH: ['SCHOOL_COUNCIL_OUTLINE_REVIEW'],
    BGH: [
      'FACULTY_COUNCIL_OUTLINE_REVIEW',
      'SCHOOL_COUNCIL_OUTLINE_REVIEW',
      'SCHOOL_COUNCIL_OUTLINE_REVIEW',
